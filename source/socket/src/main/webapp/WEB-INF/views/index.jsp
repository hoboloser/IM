...
<script>
    ...
    var wsServer = null;
    var ws = null;
    /* wsServer = "ws://" + location.host+"${pageContext.request.contextPath}" + "/socketServer"; */
    /* wsServer = "ws://218.244.150.173:9494/socket/socketServer?userid=${login_userid}"; */
    /* ws = new WebSocket(wsServer); //创建WebSocket对象 */
      ws = new SockJS("http://172.16.10.229:9494/socket/imserver");  
    /*  ws = new SockJS("http://218.244.150.173:9494/socket/imserver"); */ 
     /* ws = new SockJS("http://172.16.60.30:8083/socket/imserver"); */ 
    ...
    function showChat(message){
        ...
        var isSef = '${login_userid}' == message.from ? "am-comment-flip" : "";   //如果是自己则显示在右边,他人信息显示在左边
